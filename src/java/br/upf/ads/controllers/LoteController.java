...
public class LoteController implements Serializable {
    ...
    @EJB
    private br.upf.ads.facade.LoteFacade ejbFacade;
    ...
    public Lote getLote(java.lang.Integer id) {
    ...
    public static class LoteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getLote(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Lote) {
                Lote o = (Lote) object;
                return getStringKey(o.getLoteCodigo());
            } else {
